...
import com.hasan.travelguide.databinding.FragmentTransportationBinding
...
class TransportationFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.transportationRecyclerView.layoutManager = LinearLayoutManager(
            context,
            ...
            data?.let {
                when (it.status) {
                    Status.SUCCESS -> {
                        ...
                        binding.transportationRecyclerView.adapter = adapter
                    }
                    Status.ERROR -> {
